# RocheKAP HTTP Client

This package provides a client library for interacting with RocheKAP services, supporting all HTTP-based interface calls, making it easier for other modules to integrate with RocheKAP services without having to write HTTP request code directly.
...
4. **Knowledge Domain Management**: Create, query, and maintain knowledge-management groups
...
import (
    "context"
    "roche.local/knowledge-agent-platform/client"
    "time"
)
