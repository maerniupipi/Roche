...
// order. Provider identity for newly created models is carried in
// ModelParameters.provider while the source remains remote.
func AllModelSources() []ModelSource {
	return []ModelSource{
		ModelSourceRemote, ModelSourceAliyun, ModelSourceZhipu,
