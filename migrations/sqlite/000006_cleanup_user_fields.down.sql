...
-- This migration uses table rebuild for SQLite compatibility.
...
CREATE TABLE users_new (
    ...
    role_ops_admin INTEGER NOT NULL DEFAULT 0,
...
SELECT
    ...
    is_system_admin, status, banned_reason, banned_at, banned_by,
    0,
