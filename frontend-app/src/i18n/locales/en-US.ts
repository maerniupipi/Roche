export default {
  ...
  auth: {
    ...
    registrationRolePlaceholder: 'Select an access level',
  ...
  createChat: {
    title: 'I am your enterprise knowledge assistant, providing accurate and reliable answers based on the enterprise knowledge base.',
