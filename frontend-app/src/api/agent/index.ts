...
// 'custom'       : 完全自定义（不应用预设）
export type AgentType = 'rag-qa' | 'data-analysis' | 'custom';
...
// 内置智能体 ID（常用的保留常量，便于代码引用）// builtin-quick-answer
export const BUILTIN_QUICK_ANSWER_ID =  "2b24be48-406c-4544-a974-6e9fe6f15bc3";
...
export function listAgents(params?: {
  ...
  return get<{ data: CustomAgent[] }>(`/api/v1/agents${qs}`);
}
