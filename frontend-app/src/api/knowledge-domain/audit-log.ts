...
/**
 * List the per-knowledgeDomain audit log. Cursor-paginated by descending id.
 * Backend: GET /api/v1/knowledge-domains/:id/audit-log (Admin+).
 *
...
export async function listAuditLog(
  ...
  const url = `/api/v1/knowledge-domains/${knowledgeDomainId}/audit-log${tail ? '?' + tail : ''}`
