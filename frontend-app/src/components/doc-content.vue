...
import { MessagePlugin, DialogPlugin } from 'tdesign-mobile-vue';
...
// 的 OwnedChunkKBOrAdminFromChunkID 守卫：KB 创建者或知识域管理员。
// 才允许删除。父组件 KnowledgeBase.vue 通过 :canEditKB 把 KB 级权限
// 传下来（仅系统/部门管理员的有效管理权限），未
...
const TRACE_DRAWER_WIDTH_KEY = 'rochekap-trace-drawer-width';
...
// ============== 主抽屉（文档详情）宽度可调 ==============
const MAIN_DRAWER_WIDTH_KEY = 'rochekap-doc-drawer-width';
