// Package notion implements the Notion data source connector for RocheKAP.
//
// It syncs pages, databases, and attachments from Notion workspaces into RocheKAP knowledge bases.
//
// Notion API docs:
