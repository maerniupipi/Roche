// Package feishu implements the Feishu (飞书/Lark) data source connector for RocheKAP.
//
// It syncs documents from Feishu Wiki spaces and cloud documents into RocheKAP knowledge bases.
//
// Feishu API docs:
