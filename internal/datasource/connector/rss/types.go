// Package rss implements the RSS/Atom data source connector for RocheKAP.
//
// It syncs articles from one or more RSS/Atom/JSON feeds into a RocheKAP
...
// feed cannot redirect RocheKAP to internal services.
package rss
