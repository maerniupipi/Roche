...
const (
	...
	// DefaultSyncSchedule runs every day at 00:00. The scheduler uses a
	// 6-field cron (seconds included), so "0 0 0 * * *" = sec 0, min 0,
	// hour 0, every day.
...
type DataSource struct {
	...
	// KnowledgeDomain ID for multi-tenancy
