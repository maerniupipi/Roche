...
type ParsedChunk struct {
	...
	// PageNumber stores the page number for this chunk (memory only, for setting to Chunk metadata)
	PageNumber *int
	// PageRange stores the cross-page range for this chunk (memory only)
	PageRange *string
}
...
// PagePosition defines page position mapping structure
