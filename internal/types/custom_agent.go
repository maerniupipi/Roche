...
// tool allowlist, and other defaults so users
...
const (
	...
	// uploaded into the KB. Retrieval semantics are largely
...
type CustomAgent struct {
	...
	// CreatorName is populated for list responses and is not persisted.
...
type CustomAgentConfig struct {
	...
	// VLM model ID for image analysis.
...
type SuggestedQuestion struct {
	...
	// 来源类型: "agent_config", "faq", "document"
...
var BuiltinAgentRegistry = map[string]func() *CustomAgent{}
...
func GetBuiltinAgent(id string) *CustomAgent {
