...
// VectorStore represents a platform-wide vector database instance.
// System administrators register instances once, and knowledge bases select
// the desired instance through knowledge_bases.vector_store_id.
type VectorStore struct {
	// Unique identifier (UUID, auto-generated)
	ID string `yaml:"id" json:"id" gorm:"type:varchar(36);primaryKey"`
	// Deprecated compatibility field. Vector stores are platform-wide; this
	// value is neither persisted nor exposed by the API.
	KnowledgeDomainID uint64 `yaml:"-" json:"-" gorm:"-"`
	// User-friendly name, e.g., "elasticsearch-hot"
	Name string `yaml:"name" json:"name" gorm:"type:varchar(255);not null"`
	// Engine type: elasticsearch, qdrant, milvus, weaviate, sqlite
...
//   - SQLite is bound to the app's default database connection and remains
//     available only as an environment store.
...
// knowledgeDomain's env stores (VectorStoreID == nil).
	...
	return []VectorStoreTypeInfo{
		{
			...
			IndexFields: []VectorStoreFieldInfo{
				{Name: "index_name", Type: "string", Required: false, Description: "Index Name", Default: "rochekap"},
		...
		// SQLite is excluded because it only supports the app's default
		// database connection. It appears as an environment store.
		{
			Type:        "qdrant",
			DisplayName: "Qdrant",
			ConnectionFields: []VectorStoreFieldInfo{
			...
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_prefix", Type: "string", Required: false, Description: "Collection Prefix", Default: "roche_kap_embeddings"},
		...
		},
		{
			...
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_name", Type: "string", Required: false, Description: "Collection Name", Default: "roche_kap_embeddings"},
		...
		},
		{
			...
			ConnectionFields: []VectorStoreFieldInfo{
				...
				{Name: "database", Type: "string", Required: false, Description: "Database", Default: "rochekap"},
			},
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_name", Type: "string", Required: false, Description: "Collection Name", Default: "roche_kap_embeddings"},
		...
		},
		{
			...
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_prefix", Type: "string", Required: false, Description: "Collection Prefix", Default: "RocheKAP_embeddings"},
		...
		},
		{
			...
			ConnectionFields: []VectorStoreFieldInfo{
				...
				{Name: "database", Type: "string", Required: true, Description: "Database", Default: "rochekap"},
				{Name: "username", Type: "string", Required: false, Description: "Username", Default: "root"},
				{Name: "password", Type: "string", Required: false, Sensitive: true, Description: "Password"},
			},
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_prefix", Type: "string", Required: false, Description: "Table Prefix", Default: "roche_kap_embeddings"},
