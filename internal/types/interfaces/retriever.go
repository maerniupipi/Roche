...
type RetrieveEngineRegistry interface {
	...
	//
	// IMPORTANT: This method does NOT verify knowledgeDomain ownership of the returned
	...
	// knowledgeDomain ownership verification (defense-in-depth against cross-knowledgeDomain IDOR).
