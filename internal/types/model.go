...
type ModelParameters struct {
	...
	AppSecret      string            `yaml:"app_secret,omitempty" json:"app_secret,omitempty"` // Optional secondary provider secret, encrypted at rest.
}
...
type Model struct {
	...
	// Whether the model is provided by the platform's built-in configuration.
