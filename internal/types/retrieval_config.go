...
// RetrievalConfig holds the platform-wide retrieval/search configuration.
// This replaces the retrieval-related fields previously scattered in ConversationConfig
// Knowledge search uses these shared retrieval parameters.
//
// Stored in the singleton platform_runtime_configs row. The legacy
// /knowledge-domains/kv/retrieval-config endpoint remains as a compatibility API.
