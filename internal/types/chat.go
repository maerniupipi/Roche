...
const (
	...
	// Question understood response type (unified-QA question analysis completed)
	ResponseTypeQuestionUnderstood ResponseType = "question_understood"
	// Knowledge retrieved response type (unified-QA knowledge retrieval completed)
	ResponseTypeKnowledgeRetrieved ResponseType = "knowledge_retrieved"
	// ResponseTypeKnowledgeSearch is the legacy response value kept for callers
	// that still need to decode historical events. New unified-QA events use
	// ResponseTypeKnowledgeRetrieved.
	ResponseTypeKnowledgeSearch ResponseType = "knowledge_search"
