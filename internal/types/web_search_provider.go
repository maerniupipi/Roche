...
// WebSearchProviderEntity represents a configured web search provider instance for a knowledgeDomain.
// This is a CRUD entity stored in the database, similar to the Model entity.
// Each knowledgeDomain can create multiple provider configurations (e.g., "Production Bing", "Test Google").
// Agents reference these by ID.
type WebSearchProviderEntity struct {
	// Unique identifier (UUID, auto-generated)
	ID string `yaml:"id" json:"id" gorm:"type:varchar(36);primaryKey"`
	// KnowledgeDomain ID for scoping
	KnowledgeDomainID uint64 `yaml:"knowledge_domain_id" json:"knowledge_domain_id"`
	...
	// Whether this is the default provider for the knowledgeDomain
