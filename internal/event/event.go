...
const (
	...
	// Unified-QA user-facing milestones are separate from agent thoughts so
	// clients do not need to infer workflow nodes from thinking metadata.
	EventQuestionUnderstood EventType = "question_understood"
	EventKnowledgeSearch    EventType = "knowledge_search"
