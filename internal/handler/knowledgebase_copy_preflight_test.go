...
func (s *stubKBCopyService) CanReadKnowledgeBase(context.Context, *types.KnowledgeBase) (bool, error) {
	return true, nil
}

func (s *stubKBCopyService) CanManageKnowledgeBase(context.Context, *types.KnowledgeBase) (bool, error) {
	return true, nil
}
		...
		byID: func(_ context.Context, id string) (*types.KnowledgeBase, error) {
			...
			case "src":
				return &types.KnowledgeBase{
					ID: "src", KnowledgeDomainID: 1, EmbeddingModelID: "embed-A",
				}, nil
			case "dst":
				return &types.KnowledgeBase{
					ID: "dst", KnowledgeDomainID: 1, EmbeddingModelID: "embed-B",
				}, nil
			}
			return nil, nil
		},
...
func TestCopyHandlerPreflight_DifferentVectorStore(t *testing.T) {
	svc := &stubKBCopyService{
		byID: func(_ context.Context, id string) (*types.KnowledgeBase, error) {
			...
			case "dst":
				return &types.KnowledgeBase{
					ID: "dst", KnowledgeDomainID: 1, EmbeddingModelID: "embed-A",
