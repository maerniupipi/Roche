...
type Handler struct {
	...
	suggestedQuestions   interfaces.SuggestedQuestionService
...
func (h *Handler) CreateSession(c *gin.Context) {
	...
	// otherwise they fall back to the synthetic knowledgeDomain user.
...
func (h *Handler) GetSessions(c *gin.Context) {
	...
	// Unset filter params behave like "no filter".
