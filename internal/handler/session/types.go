...
type CreateKnowledgeQARequest struct {
	...
	SuggestedQuestionID string                 `json:"suggested_question_id,omitempty"`       // Global homepage suggestion selected by the user
	...
	Channel           string             `json:"channel"`                      // Client channel: "web" or "app".
}
