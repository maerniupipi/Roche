...
import (
	...
	"roche.local/knowledge-agent-platform/internal/models/provider"
...
func (h *ModelHandler) CreateModel(c *gin.Context) {
	...
	logger.Infof(ctx, "Creating model, name: %s, type: %s",
		secutils.SanitizeForLog(req.Name), secutils.SanitizeForLog(string(req.Type)))
...
func (h *ModelHandler) ListModels(c *gin.Context) {
	...
	logger.Infof(ctx, "Retrieved global model list successfully, total: %d models", len(models))
...
// @Param        input formData string false "Model input"
// @Param        options formData string false "Provider options JSON"
// @Param        documents formData string false "Rerank document JSON array"
// @Param        file formData file false "Optional multimodal or ASR input"
