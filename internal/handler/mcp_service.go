...
func (h *MCPServiceHandler) CreateMCPService(c *gin.Context) {
	...
	if knowledgeDomainID == 0 {
		logger.Error(ctx, "KnowledgeDomain ID is empty")
		c.Error(errors.NewBadRequestError("KnowledgeDomain ID cannot be empty"))
		return
	}
	service.KnowledgeDomainID = knowledgeDomainID
...
func (h *MCPServiceHandler) ListMCPServices(c *gin.Context) {
	...
	services, err := h.mcpServiceService.ListMCPServices(ctx, knowledgeDomainID)
	if err != nil {
...
func (h *MCPServiceHandler) GetMCPService(c *gin.Context) {
	...
	service, err := h.mcpServiceService.GetMCPServiceByID(ctx, knowledgeDomainID, serviceID)
	if err != nil {
	...
	// so the cross-knowledgeDomain builtin list does not leak per-knowledgeDomain config.
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"data":    dto.NewMCPServiceResponse(ctx, service),
	})
...
func (h *MCPServiceHandler) UpdateMCPService(c *gin.Context) {
	...
	stored, err := h.mcpServiceService.GetMCPServiceByID(ctx, knowledgeDomainID, serviceID)
	if err != nil {
...
func (h *MCPServiceHandler) DeleteMCPService(c *gin.Context) {
	...
	if err := h.mcpServiceService.DeleteMCPService(ctx, knowledgeDomainID, serviceID); err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{"service_id": secutils.SanitizeForLog(serviceID)})
...
func (h *MCPServiceHandler) TestMCPService(c *gin.Context) {
	...
	result, err := h.mcpServiceService.TestMCPService(ctx, knowledgeDomainID, serviceID)
	if err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{"service_id": secutils.SanitizeForLog(serviceID)})
		c.JSON(http.StatusOK, gin.H{
			"success": true,
...
func (h *MCPServiceHandler) GetMCPServiceTools(c *gin.Context) {
	...
	tools, err := h.mcpServiceService.GetMCPServiceTools(ctx, knowledgeDomainID, serviceID)
	if err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{"service_id": secutils.SanitizeForLog(serviceID)})
...
func (h *MCPServiceHandler) GetMCPServiceResources(c *gin.Context) {
	...
	resources, err := h.mcpServiceService.GetMCPServiceResources(ctx, knowledgeDomainID, serviceID)
	if err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{"service_id": secutils.SanitizeForLog(serviceID)})
...
func (h *MCPServiceHandler) ListMCPToolApprovals(c *gin.Context) {
	...
	rows, err := h.mcpToolApprovalService.ListByService(ctx, knowledgeDomainID, serviceID)
	if err != nil {
...
func (h *MCPServiceHandler) SetMCPToolApproval(c *gin.Context) {
	...
	if err := h.mcpToolApprovalService.SetRequireApproval(ctx, knowledgeDomainID, serviceID, toolName, body.RequireApproval); err != nil {
		c.Error(errors.NewInternalServerError(err.Error()))
		return
	}
...
func (h *MCPServiceHandler) ResolveToolApproval(c *gin.Context) {
	...
	if err := h.toolApprovalGate.Resolve(knowledgeDomainID, gateUserID, pendingID, dec); err != nil {
		switch {
		...
		case stderrors.Is(err, approval.ErrKnowledgeDomainMismatch):
			c.Error(errors.NewBadRequestError("knowledgeDomain mismatch"))
