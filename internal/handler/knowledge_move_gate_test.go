...
func (s *stubMoveKBService) CanReadKnowledgeBase(context.Context, *types.KnowledgeBase) (bool, error) {
	return true, nil
}

func (s *stubMoveKBService) CanManageKnowledgeBase(context.Context, *types.KnowledgeBase) (bool, error) {
	return true, nil
}
...
func TestMoveKnowledge_CrossStoreGate(t *testing.T) {
	...
	kbWith := func(id string, store *string) *types.KnowledgeBase {
		return &types.KnowledgeBase{ID: id, KnowledgeDomainID: 1, Type: "document",
