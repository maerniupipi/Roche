...
import (
	...
	agentmemory "roche.local/knowledge-agent-platform/internal/agent/memory"
	"roche.local/knowledge-agent-platform/internal/agent/skills"
	agenttoken "roche.local/knowledge-agent-platform/internal/agent/token"
	agenttools "roche.local/knowledge-agent-platform/internal/agent/tools"
	"roche.local/knowledge-agent-platform/internal/common"
	appconfig "roche.local/knowledge-agent-platform/internal/config"
...
func (e *AgentEngine) Execute(
	...
	_, err := e.executeLoop(ctx, state, query, messages, sessionID, messageID)
	if err != nil {
