...
func insertProcessingKnowledge(t *testing.T, db *gorm.DB) string {
	...
	require.NoError(t, db.Exec(`
		INSERT INTO knowledges (id, knowledge_domain_id, knowledge_base_id, type, title, source, parse_status, pending_subtasks_count)
...
func insertKnowledgeWithStatus(t *testing.T, db *gorm.DB, status string, deleted bool) string {
	...
	require.NoError(t, db.Exec(`
		INSERT INTO knowledges (id, knowledge_domain_id, knowledge_base_id, type, title, source, parse_status, deleted_at)
