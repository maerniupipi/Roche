...
type Repository struct {
	client    *osapi.Client
	baseIndex string      // pre-suffix base name, e.g. "roche_kap_abcdef012345"
...
//   - storeID == ""       — env-path; no prefix, base index = "rochekap".
...
func NewRepository(
	...
	base := types.ResolveIndexName(indexCfg, "OPENSEARCH_INDEX", "rochekap")
	if storeID != "" {
