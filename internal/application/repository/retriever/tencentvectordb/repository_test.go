...
func TestCollectionNameUsesDimensionSuffixByDefault(t *testing.T) {
	...
	assert.Equal(t, "roche_kap_embeddings_1024", repo.collectionName(1024))
	assert.True(t, repo.matchesCollection("roche_kap_embeddings_1024"))
	assert.False(t, repo.matchesCollection("roche_kap_embeddings"))
}
