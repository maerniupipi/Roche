...
func (s *tagTargetKnowledgeService) GetKnowledgeByIDOnly(
	_ context.Context,
	id string,
...
func newTagTargetSessionService() *sessionService {
	return &sessionService{
		knowledgeBaseService: &tagTargetKnowledgeBaseService{
			kbs: map[string]*types.KnowledgeBase{
				"doc-kb": {ID: "doc-kb", KnowledgeDomainID: 100, Type: types.KnowledgeBaseTypeDocument},
				"faq-kb": {ID: "faq-kb", KnowledgeDomainID: 100, Type: types.KnowledgeBaseTypeFAQ},
			},
		},
		knowledgeService: &tagTargetKnowledgeService{
			knowledges: []*types.Knowledge{
				{ID: "doc-1", KnowledgeDomainID: 100, KnowledgeBaseID: "doc-kb"},
				{ID: "doc-2", KnowledgeDomainID: 100, KnowledgeBaseID: "doc-kb"},
				{ID: "doc-3", KnowledgeDomainID: 100, KnowledgeBaseID: "doc-kb"},
			},
			tagIDs: map[string][]string{
				"doc-1": {"tag-a"},
				"doc-2": {"tag-b"},
...
func tagTargetContext() context.Context {
	return context.WithValue(context.Background(), types.KnowledgeDomainIDContextKey, uint64(100))
}
...
func (s *tagTargetKnowledgeServiceWithError) ListKnowledgeIDsByTagIDs(
	...
	return s.tagTargetKnowledgeService.ListKnowledgeIDsByTagIDs(ctx, knowledgeDomainID, kbID, tagIDs)
}
