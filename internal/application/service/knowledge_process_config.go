...
// MergeParserEngineOverrides merges upload overrides on top of knowledgeDomain overrides safely.
func MergeParserEngineOverrides(knowledgeDomainOverrides map[string]string, uploadOverrides map[string]string) map[string]string {
	merged := make(map[string]string)
	for k, v := range knowledgeDomainOverrides {
		merged[k] = v
	}
