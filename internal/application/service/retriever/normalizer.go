...
// sqlite-vec / Qdrant / Weaviate docs, and the Lucene
...
//	    sqlite-vec docs: "0 for identical, 2 for opposite").
...
//
// IR-normalization caveat (applies to sqlite-vec, Qdrant,
...
func (EngineAwareNormalizer) Normalize(
	...
	case types.ElasticsearchRetrieverEngineType,
		...
		// caveat covering sqlite-vec / Qdrant /
