...
// (knowledgeDomain/exports) and returns its local:// path.
func seedLocalObject(t *testing.T, baseDir string, knowledgeDomainID uint64, name string, data []byte) string {
	t.Helper()
