...
func TestParseOssFilePath(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input:      "oss://bucket/prefix/knowledgeDomain/exports/uuid.png",
			wantBucket: "bucket",
			wantKey:    "prefix/knowledgeDomain/exports/uuid.png",
		},
		{
			name:        "invalid scheme",
			input:       "s3://bucket/key",
...
func TestOssEnsureBucket_CreateFails(t *testing.T) {
	...
	err = ossEnsureBucket(client, "rochekap-nonexistent-bucket-create-fails-12345")
	if err == nil {
