...
func (s *processSyncKBService) ListKnowledgeBasesByKnowledgeDomainID(context.Context, uint64) ([]*types.KnowledgeBase, error) {
	return nil, nil
}
...
func (s *processSyncKBService) TogglePublicKnowledgeBase(context.Context, string, bool) (*types.KnowledgeBase, error) {
	return nil, nil
}
