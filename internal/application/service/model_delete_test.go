...
func (s *stubKBRepoForModelDelete) GetKnowledgeBaseByIDAndKnowledgeDomain(context.Context, string, uint64) (*types.KnowledgeBase, error) {
	return nil, nil
}
...
func (s *stubKBRepoForModelDelete) ListKnowledgeBasesByKnowledgeDomainID(context.Context, uint64) ([]*types.KnowledgeBase, error) {
	return nil, nil
}
...
func (s *stubKBRepoForModelDelete) CountByModelID(context.Context, string) (int64, error) {
	return s.count, nil
}
...
func (s *stubAgentRepoForModelDelete) GetAgentByID(context.Context, string) (*types.CustomAgent, error) {
	return nil, nil
}
func (s *stubAgentRepoForModelDelete) ListAgents(context.Context) ([]*types.CustomAgent, error) {
	return nil, nil
}
func (s *stubAgentRepoForModelDelete) UpdateAgent(context.Context, *types.CustomAgent) error {
	return nil
}
func (s *stubAgentRepoForModelDelete) DeleteAgent(context.Context, string) error { return nil }
func (s *stubAgentRepoForModelDelete) CountByModelID(context.Context, string) (int64, error) {
	return s.count, nil
}
...
func (s *stubModelRepoForDelete) GetByID(_ context.Context, id string) (*types.Model, error) {
	if s.model != nil && s.model.ID == id {
		return s.model, nil
	}
	return nil, nil
}
func (s *stubModelRepoForDelete) List(context.Context, types.ModelType, types.ModelSource) ([]*types.Model, error) {
	return nil, nil
}
func (s *stubModelRepoForDelete) Update(context.Context, *types.Model) error { return nil }
func (s *stubModelRepoForDelete) Delete(_ context.Context, id string) error {
	if s.delete != nil {
		return s.delete(id)
	}
	return nil
}
func (s *stubModelRepoForDelete) ClearDefaultByType(context.Context, types.ModelType, string) error {
	return nil
}
...
func TestDeleteModel_RejectsWhenReferenced(t *testing.T) {
	...
	svc := NewModelService(
		&stubModelRepoForDelete{model: &types.Model{ID: modelID}},
