// Package service provides business logic implementations for RocheKAP application
...
// This method fetches a specific chunk using its ID and validates knowledgeDomain access
// Parameters:
//   - ctx: Context with authentication and request information
...
func (s *chunkService) GetChunkByID(ctx context.Context, id string) (*types.Chunk, error) {
	...
	logger.Infof(ctx, "Getting chunk by ID, ID: %s, knowledgeDomain ID: %d", id, knowledgeDomainID)
	chunk, err := s.chunkRepository.GetChunkByID(ctx, knowledgeDomainID, id)
	if err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{
...
func (s *chunkService) ListChunksByKnowledgeID(ctx context.Context, knowledgeID string) ([]*types.Chunk, error) {
	...
	knowledgeDomainID := types.MustKnowledgeDomainIDFromContext(ctx)
	logger.Infof(ctx, "KnowledgeDomain ID: %d", knowledgeDomainID)

	chunks, err := s.chunkRepository.ListChunksByKnowledgeID(ctx, knowledgeDomainID, knowledgeID)
	if err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{
...
func (s *chunkService) DeleteChunk(ctx context.Context, id string) error {
	knowledgeDomainID := types.MustKnowledgeDomainIDFromContext(ctx)
	err := s.chunkRepository.DeleteChunk(ctx, knowledgeDomainID, id)
	if err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{
			"knowledge_domain_id": knowledgeDomainID,
		})
...
func (s *chunkService) DeleteChunks(ctx context.Context, ids []string) error {
	...
	err := s.chunkRepository.DeleteChunks(ctx, knowledgeDomainID, ids)
	if err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{
			"chunk_ids":           ids,
			"knowledge_domain_id": knowledgeDomainID,
...
func (s *chunkService) DeleteChunksByKnowledgeID(ctx context.Context, knowledgeID string) error {
	...
	err := s.chunkRepository.DeleteChunksByKnowledgeID(ctx, knowledgeDomainID, knowledgeID)
	if err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{
			"knowledge_id":        knowledgeID,
			"knowledge_domain_id": knowledgeDomainID,
...
func (s *chunkService) DeleteByKnowledgeList(ctx context.Context, ids []string) error {
	...
	err := s.chunkRepository.DeleteByKnowledgeList(ctx, knowledgeDomainID, ids)
	if err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{
			"knowledge_id":        ids,
			"knowledge_domain_id": knowledgeDomainID,
...
func (s *chunkService) ListChunkByParentID(
	...
	chunks, err := s.chunkRepository.ListChunkByParentID(ctx, knowledgeDomainID, parentID)
	if err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{
			"parent_id":           parentID,
			"knowledge_domain_id": knowledgeDomainID,
...
func (s *chunkService) DeleteGeneratedQuestion(ctx context.Context, chunkID string, questionID string) error {
	...
	// 1. Get the chunk
	chunk, err := s.chunkRepository.GetChunkByID(ctx, knowledgeDomainID, chunkID)
	if err != nil {
		logger.ErrorWithFields(ctx, err, map[string]interface{}{
			"chunk_id":            chunkID,
			"knowledge_domain_id": knowledgeDomainID,
