...
func (c *countingFileService) SaveFile(ctx context.Context, file *multipart.FileHeader, knowledgeDomainID uint64, knowledgeID string) (string, error) {
	return "", nil
}

func (c *countingFileService) SaveBytes(ctx context.Context, data []byte, knowledgeDomainID uint64, fileName string, temp bool) (string, error) {
	return "", nil
}
...
func (c *countingFileService) CopyFile(ctx context.Context, srcPath string, knowledgeDomainID uint64, knowledgeID string) (string, error) {
	...
	return fmt.Sprintf("local://%d/%s/copy-of-%s", knowledgeDomainID, knowledgeID, srcPath), nil
}
