...
const emit = defineEmits<{
  ...
  (e: 'action', action: 'edit' | 'reparse' | 'cancel-parse' | 'move' | 'view-trace' | 'batch-manage', item: KnowledgeItem): void;
...
const handleAction = (action: 'edit' | 'reparse' | 'cancel-parse' | 'move' | 'view-trace' | 'batch-manage', item: KnowledgeItem) => {
  ...
  <div class="doc-list-view" :class="{ 'is-loading': loading }">
    ...
    <div class="doc-list-body">
      <div v-for="item in items" :key="item.id" class="doc-list-row"
        ...
        <div class="cell cell-actions" v-if="canEdit || item.my_permission === 'manage'" @click.stop>
