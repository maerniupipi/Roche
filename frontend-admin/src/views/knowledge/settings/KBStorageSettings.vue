...
// Keep empty until knowledgeDomain default_provider is loaded — do not pre-fill 'local'.
...
// storageProvider empty until load() applies knowledgeDomain default_provider.
