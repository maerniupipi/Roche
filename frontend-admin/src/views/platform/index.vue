<template>
  <div class="main" ref="dropzone" :class="{ 'platform-content--creat-chat': isCreatChatRoute }">
    ...
    <GlobalCommandPalette v-if="canManageKnowledge" />
    <!-- 带遮罩层的新手引导：首次进入自动开启，可从用户菜单顶部昵称旁帮助按钮重新打开 -->
    <NewUserGuide v-if="canManageKnowledge" />
  </div>
</template>
...
const CREAT_CHAT_ROUTE_NAMES = new Set(['globalCreatChat', 'kbCreatChat']);
