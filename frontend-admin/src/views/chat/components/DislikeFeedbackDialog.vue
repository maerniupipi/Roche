...
const reasonOptions = computed<ReasonOption[]>(() => [
  { key: 'search_relevance', label: t('agentStream.feedback.dialog.reasons.search_relevance') },
  { key: 'summary_unclear', label: t('agentStream.feedback.dialog.reasons.summary_unclear') },
  { key: 'key_info_misplaced', label: t('agentStream.feedback.dialog.reasons.key_info_misplaced') },
