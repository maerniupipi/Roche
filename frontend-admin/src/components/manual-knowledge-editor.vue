...
.toggle-view-btn {
  ...
  &:hover {
    border-color: rgba(11, 65, 205, 0.45);
    background: rgba(11, 65, 205, 0.06);
    color: var(--td-brand-color);
    box-shadow: 0 2px 6px rgba(11, 65, 205, 0.1);
  }

  &.is-preview {
    border-color: rgba(11, 65, 205, 0.5);
...
.toolbar-btn:hover {
  background: rgba(11, 65, 205, 0.08);
  color: var(--td-brand-color);
...
.toolbar-btn.active {
  background: rgba(11, 65, 205, 0.12);
  color: var(--td-brand-color);
...
.toolbar-btn:focus-visible {
  outline: none;
  box-shadow: 0 0 0 2px rgba(11, 65, 205, 0.25);
}

.toolbar-btn:active {
  background: rgba(11, 65, 205, 0.15);
...
.editor-area {
  ...
  &:focus-within {
    ...
    box-shadow: 0 0 0 2px rgba(11, 65, 205, 0.1);
  }
}
