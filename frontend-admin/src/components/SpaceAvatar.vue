...
// 预定义渐变色（与项目蓝色主色协调，偏空间/协作感）
const gradients = [
  { from: '#0B41CD', to: '#022366' },  // 主蓝
  { from: '#042370', to: '#0B41CD' },  // 深蓝渐变
  { from: '#6488E6', to: '#1482FA' },  // 蓝青
  { from: '#1482FA', to: '#6CACFC' },  // 浅蓝渐变
  { from: '#36d1dc', to: '#5b86e5' },  // 青蓝
  { from: '#4facfe', to: '#00f2fe' },  // 蓝青
  { from: '#667eea', to: '#764ba2' },  // 紫蓝
  { from: '#4776e6', to: '#8e54e9' },  // 蓝紫
  { from: '#1E40AF', to: '#3B82F6' },  // 蓝渐变
  { from: '#0EA5E9', to: '#06B6D4' },  // 青蓝
