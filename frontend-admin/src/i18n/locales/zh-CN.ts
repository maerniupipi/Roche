export default {
  ...
  menu: {
    knowledgeBase: "知识库",
    dashboard: "仪表盘",
    recommendQuestions: "推荐问题管理",
    answerRecords: "用户回答记录",
    roles: "用户角色配置",
    exchangeRate: "汇率换算",
    chat: "对话",
    newChat: "新对话",
  ...
  exchangeRate: {
    ...
    confirm: "确认修改",
    submitSuccess: "保存成功",
    submitFailed: "保存失败，请稍后再试",
    submitError: "提交失败",
  },
  recommendQuestions: {
    title: "首页推荐问题编辑",
    moduleTitle: "推荐问题 {index}",
    questionPlaceholder: "请输入推荐问题",
    customAnswerToggleLabel: "启用固定回答",
    customAnswerPlaceholder: "请输入回答",
    duplicateError: "3 个推荐问题不能重复",
    confirm: "确认修改",
    submitSuccess: "保存成功",
    submitFailed: "保存失败，请稍后再试",
  },
  ...
  contextualGuide: {
    ...
    agentList: {
      steps: {
        create: {
          title: "创建你的智能体",
          desc: "智能体把模型、工具与提示词组合成可复用的对话助手，知识访问统一继承当前用户授权。点击下方高亮的「创建智能体」开始配置。",
        },
      },
    },
    agentCreate: {
      steps: {
        ...
        agentType: {
          title: "选择智能体类型",
          desc: "预设类型会自动填充系统提示词与推荐工具（如 RAG 问答、数据分析等）。知识访问始终取决于当前用户授权。",
        },
        name: {
          title: "命名与描述",
        ...
        navTools: {
          title: "工具（可选）",
          desc: "智能推理模式下可勾选内置工具，扩展搜索、计算等能力。",
        },
        submit: {
          title: "保存智能体",
  ...
  agent: {
    ...
    selector: {
      ...
      addNew: "添加新智能体",
      current: "当前",
      goToSettings: "设置", notReadyHint: "尚未就绪，还需配置：{items}",
      notReadyStatus: "待配置",
  ...
  system: {
    ...
    retry: "重试",
    versionLabel: "应用版本",
    versionDescription: "当前应用服务（rochekap-app）的版本号",
    frontendVersionLabel: "UI 版本",
    frontendVersionDescription: "当前 UI 界面（rochekap-ui）的构建版本号",
    ...
    dbMigrationFailedDesc: "启动时数据库迁移未成功完成，部分表或索引可能未创建，会导致知识图谱等功能异常。建议先查看排查文档自助修复；如仍无法解决，请通过下方链接反馈。",
  ...
  createChat: {
    title: "Hi，我是 Roche Knowledge Agent Platform，让你的知识触手可及",
  ...
  enterpriseOrg: {
    title: "企业组织",
    description: "分别管理平台手工组织和 Workday 企业人员目录。组织仅用于批量授权，加入组织不会自动获得任何知识权限。",
    manualTab: "手工组织",
    workdayTab: "Workday 目录",
    manualDescription: "由平台管理员维护的授权分组，可独立新增组织和调整成员。",
    workdayDescription: "来自 Workday 的只读企业组织和员工投影，不会覆盖手工组织。",
    organizationTree: "组织树",
    manualOrganizationTree: "手工组织树",
    workdayOrganizationTree: "Workday 组织树",
    create: "新建组织",
    edit: "编辑组织",
    name: "组织名称",
    code: "组织编码",
    ...
    workdaySync: "全量同步 Workday",
    workdaySyncConfirm: "将使用当前 Workday 数据源执行全量组织和员工同步，确认继续吗？",
    workdaySyncSucceeded: "Workday 全量同步完成",
    workdaySyncFailed: "Workday 全量同步失败",
    workdaySyncPending: "同步任务仍在后台执行，请稍后刷新组织列表",
    workdayLoadFailed: "加载 Workday 员工目录失败",
    workdayMemberDescription: "显示该 Workday 组织及其下级组织的员工，包括尚未绑定平台账号的员工。",
    workdayNoOrganizations: "尚未同步 Workday 组织",
    workdayNoWorkers: "该组织范围内暂无 Workday 员工",
    selectWorkdayOrganization: "请先从左侧选择一个 Workday 组织",
    searchWorkdayWorkers: "搜索员工姓名、邮箱或 Workday ID",
    workerCount: "{count} 名员工",
    linkedAccount: "已绑定系统账号",
    unlinkedAccount: "未绑定系统账号",
  },
  knowledgeList: {
    root: "知识库",
    create: "新建知识库",
    ...
    simpleModal: {
      subtitle: "填写名称与描述即可创建一个新的知识库，模型与解析会按默认配置初始化。",
      nameLabel: "知识库名称",
      namePlaceholder: "请输入知识库名称",
      descriptionLabel: "知识库描述",
      descriptionPlaceholder: "请输入知识库描述（可选）",
      submit: "创建",
      modelsMissing: "请先在系统设置中添加对话模型与 Embedding 模型",
    },
    features: {
      knowledgeGraph: "知识图谱",
    },
  ...
  agentStream: {
    ...
    feedback: {
      ...
      dialog: {
        ...
        close: "关闭",
        reasons: {
          search_relevance: "搜索结果相关性不足",
          summary_unclear: "文档摘要不清晰",
          key_info_misplaced: "关键信息定位不准",
          other: "其他",
        },
  ...
  datasource: {
    ...
    noResources_google_drive: "未找到可同步的 Google Drive 文件",
    noResourcesDesc_google_drive: "未找到可访问的 Google Drive 文件。请将目标文件夹或共享云端硬盘共享给服务账号。",
    guideStep1_google_drive: "在 Google Cloud 中启用 Google Drive API，并创建服务账号密钥 JSON",
    guideStep2_google_drive: "将目标文件夹或共享云端硬盘共享给服务账号 JSON 中的 client_email",
    guideStep3_google_drive: "如使用域范围委派，请由 Workspace 管理员授权 drive.readonly 范围并填写委派用户",
    prereqBarText_google_drive: "首次使用？点击查看 Google Drive 服务账号配置指引",
    prereqStep1Brief_google_drive: "启用 Drive API 并创建服务账号",
    prereqStep1Desc_google_drive: "在 Google Cloud 项目中启用 Google Drive API，创建服务账号并下载 JSON 密钥",
    prereqStep2Brief_google_drive: "授予只读访问范围",
    prereqStep2Desc_google_drive: "连接器仅使用 https://www.googleapis.com/auth/drive.readonly",
    prereqStep3Brief_google_drive: "共享文件或配置域范围委派",
    prereqStep3Desc_google_drive: "普通模式下把目标内容共享给 client_email；企业域委派模式下填写被委派用户邮箱",
    prereqOpenConsole_google_drive: "打开 Google Cloud 服务账号控制台",
    connector: {
      feishu: "飞书",
      notion: "Notion",
    ...
    connectorDesc: {
      google_drive: "递归同步 Google Drive 文件夹、共享云端硬盘、Google 文档和普通文件",
    ...
    field: {
      ...
      serviceAccountJsonHint: "粘贴完整的服务账号密钥 JSON；保存时会使用系统 AES 密钥加密",
      delegatedUser: "委派用户邮箱（可选）",
      delegatedUserHint: "仅在 Google Workspace 已配置域范围委派时填写；否则请将文件共享给服务账号 client_email",
      appId: "App ID",
  ...
  roles: {
    subtitle: "管理用户账号、知识官、运维员与拉黑状态",
    description: "查看与维护企业成员在平台的角色与访问权限",
    filters: {
      account: "用户账号",
      employeeName: "员工名称",
      isKnowledgeOfficer: "是否知识官",
      isOperationsAdmin: "是否运维员",
      department: "所属部门",
      placeholder: "请输入或选择",
    },
    columns: {
    ...
    actions: {
      ...
      setOpsAdmin: "设为运维员",
      unsetOpsAdmin: "取消运维员",
      setKnowledgeOfficer: "设为知识官",
      unsetKnowledgeOfficer: "取消知识官",
      addUser: "新增用户",
    },
    pagination: {
      all: "全部",
    ...
    operator: {
      confirmTitle: "确认提交吗？",
      setMessage: "确认后，用户'{name}'将设置为运维员",
      unsetMessage: "确认后，用户'{name}'将取消运维员身份",
      selfProtect: "不能对自己执行该操作",
    },
    ban: {
      selfProtect: "不能对自己执行该操作",
    },
    knowledgeOfficer: {
      scopeTitle: "设置知识官管理范围",
      scopeSubtitle: "请选择'{name}'可管理的知识域与知识库（可全部留空）",
      confirmTitle: "确认提交吗？",
      setMessage: "确认后，用户'{name}'将设置为知识官",
      unsetMessage: "确认后，用户'{name}'将取消知识官身份",
      domainLabel: "知识域",
      baseLabel: "知识库",
      domainPlaceholder: "请选择知识域",
      basePlaceholder: "请选择知识库",
      noDomains: "暂无可用知识域",
      noBases: "暂无可用知识库",
      emptyScopeWarning: "未选择任何范围，将以\"全量\"提交",
      submit: "确认",
      cancel: "取消",
      selfProtect: "不能对自己执行该操作",
      batchScopeTitle: "批量设置知识官管理范围",
      batchScopeSubtitle: "已选 {count} 名用户，设置其可管理的知识域与知识库（可全部留空）",
      batchSetMessage: "确认后，所选 {count} 名用户将设置为知识官",
      batchUnsetMessage: "确认后，所选 {count} 名用户将取消知识官身份",
      batchConfirmTitle: "确认提交吗？",
    },
    messages: {
      loadFailed: "加载失败，请稍后再试",
      operationSuccess: "操作成功",
      operationFailed: "操作失败，请稍后再试",
      selectRequired: "请先选择用户",
      selectInconsistent: "所选用户状态不一致，无法执行此操作",
      cannotOperateSelf: "不能对自己执行该操作",
      addUser: {
        dialogTitle: "新增用户",
        dialogSubtitle:
          "请输入用户账号或邮箱地址；含 {'@'} 将按邮箱邀请，否则按用户 ID 添加",
        inputLabel: "用户账号 / 邮箱",
        inputPlaceholder: "请输入用户账号或邮箱地址",
        submit: "确认添加",
        cancel: "取消",
        emptyInput: "请输入用户账号或邮箱地址",
        userCreated: "用户已添加",
        createFailed: "添加失败，请稍后再试",
      },
    },
  },
  answerRecords: {
    title: "用户回答记录",
    subtitle: "查看用户在 Web 端与 App 端的回答记录与反馈",
    description: "可按应用端、用户名、反馈类型、时间区间检索用户的问答记录，支持导出。",
    filters: {
      channel: "应用端",
  ...
  dashboard: {
    ...
    kbStats: {
      ...
      hint: "文档数与命中率",
      published: "已上架文件数",
      uploadSuccess: "上传成功文件数",
      uploadFailed: "上传失败文件数",
      pending: "预约上架文件数",
      offline: "已下架文件数",
      archived: "归档文件数",
    },
    ...
    summary: {
      title: "本月表现总结",
      highlight: "回答准时率提升 4.6%，问答满意度上升至 92.3%。",
    },
    overview: {
      totalQuestions: "累计提问数",
      totalAnswers: "累计回答数",
      activeUsers: "活跃用户",
      positiveRate: "好评率",
    },
