export default {
  ...
  menu: {
    ...
    dashboard: 'Dashboard',
    recommendQuestions: 'Suggested Questions',
  ...
  exchangeRate: {
    ...
    submitFailed: 'Failed to save, please try again later',
    submitError: 'Submit failed',
  },
  recommendQuestions: {
    title: 'Home Recommended Questions',
    moduleTitle: 'Question {index}',
    questionPlaceholder: 'Enter the suggested question',
    customAnswerToggleLabel: 'Enable fixed answer',
    customAnswerPlaceholder: 'Enter the answer',
    duplicateError: 'The three questions must be unique',
    confirm: 'Confirm',
    submitSuccess: 'Saved successfully',
    submitFailed: 'Failed to save, please try again later',
  },
    ...
    agentCreate: {
      steps: {
        ...
        navTools: {
          ...
          desc: 'In smart-reasoning mode, enable built-in tools for search, code, and more.',
        },
        submit: {
  ...
  knowledgeBase: {
    ...
    accessInfo: {
      ...
      permissionRead: 'View and search only',
  ...
  input: {
    addModel: 'Add Model',
    disclaimer: 'AI generated content is for reference only. If you have questions, please consult relevant professional institutions.',
  ...
  enterpriseOrg: {
    ...
    description: 'Manage platform-maintained groups and the Workday enterprise directory separately. Organization membership is only a bulk-grant subject and never grants knowledge access by itself.',
    manualTab: 'Manual organizations',
    workdayTab: 'Workday directory',
    manualDescription: 'Authorization groups maintained by platform administrators. Organizations and memberships can be edited independently.',
    workdayDescription: 'Read-only enterprise organizations and workers synchronized from Workday. Manual organizations are never overwritten.',
    organizationTree: 'Organization tree',
    manualOrganizationTree: 'Manual organization tree',
    workdayOrganizationTree: 'Workday organization tree',
    ...
    workdaySync: 'Full Workday sync',
    workdaySyncConfirm: 'Run a full organization and worker sync using the configured Workday provider?',
    workdaySyncSucceeded: 'Workday full sync completed',
    workdaySyncFailed: 'Workday full sync failed',
    workdaySyncPending: 'The sync is still running in the background. Refresh the organization list later.',
    workdayLoadFailed: 'Failed to load the Workday directory',
    workdayMemberDescription: 'Workers in this Workday organization and its descendants, including workers not yet linked to a platform account.',
    workdayNoOrganizations: 'No Workday organizations have been synchronized',
    workdayNoWorkers: 'No Workday workers in this organization scope',
    selectWorkdayOrganization: 'Select a Workday organization on the left',
    searchWorkdayWorkers: 'Search by worker name, email, or Workday ID',
    workerCount: '{count} workers',
    linkedAccount: 'Platform account linked',
    unlinkedAccount: 'Platform account not linked',
  },
  knowledgeList: {
    root: 'Knowledge Bases',
    create: 'Create Knowledge Base',
    createShort: 'New',
    createDomain: 'Create Knowledge Domain',
    ...
    simpleModal: {
      subtitle: 'Fill in the name and description to create a new knowledge base. Models and parsing use the default configuration.',
      ...
      submit: 'Create',
      modelsMissing: 'Please add a chat model and an embedding model in System Settings first',
    },
    features: {
...
\
  ...
  chat: {
    ...
    referencesDocCount: 'Referenced {count} source(s)',
    ...
    inlineDocumentPreviewTitle: 'Document preview',
  ...
  preview: {
    ...
    watermarkPrefix: 'Confidential · For',
    watermarkSuffix: 'viewing only',
    copyDisabled: 'Copying is disabled',
    saveDisabled: 'Downloading is disabled',
  },
  commandPalette: {
  ...
  agentStream: {
    ...
    feedback: {
      like: 'Like',
      likeTip: 'This answer is helpful',
      dislike: 'Dislike',
      dislikeTip: 'This answer is not ideal',
      alreadyLiked: 'Liked',
      alreadyDisliked: 'Disliked',
      dialog: {
        title: 'Which part are you most dissatisfied with?',
        close: 'Close',
        reasons: {
          search_relevance: 'Search results not relevant enough',
          summary_unclear: 'Document summary is unclear',
          key_info_misplaced: 'Key information is misplaced',
          other: 'Other',
        },
        otherPlaceholder: "Tell us what's wrong so we can improve",
        commentRequired: 'Please describe your concern or suggestion',
        confirm: 'Submit',
        cancel: 'Cancel',
        submitting: 'Submitting…',
        submitted: 'Thanks for your feedback — we will keep improving',
  ...
  roles: {
    subtitle: "Manage user accounts, knowledge officers, operations admins and blacklist status",
    description: "View and maintain enterprise members' platform roles and access",
    filters: {
      account: "Account",
      employeeName: "Employee Name",
      isKnowledgeOfficer: "Is Knowledge Officer",
      isOperationsAdmin: "Is Ops Admin",
    ...
    columns: {
      ...
      email: "Email",
      status: "Status",
      isKnowledgeOfficer: "Knowledge Officer",
      isOperationsAdmin: "Ops Admin",
      department: "Department",
      action: "Action",
    },
    status: {
    ...
    actions: {
      ...
      setOpsAdmin: "Set as Ops Admin",
      unsetOpsAdmin: "Remove Ops Admin",
      setKnowledgeOfficer: "Set as Knowledge Officer",
      unsetKnowledgeOfficer: "Remove Knowledge Officer",
      addUser: "Add User",
    },
    pagination: {
      all: "All",
    ...
    footer: {
      selected: "Selected {count} / Total {total}",
    },
    detail: {
      title: "User Detail",
      employeeId: "Employee ID",
    ...
    operator: {
      ...
      setMessage: "After confirmation, user '{name}' will be set as an Ops Admin",
      unsetMessage: "After confirmation, user '{name}' will be removed from Ops Admin",
      selfProtect: "Cannot perform this action on yourself",
    },
    ban: {
      selfProtect: "Cannot perform this action on yourself",
    },
    knowledgeOfficer: {
      scopeTitle: "Set Knowledge Officer scope",
      scopeSubtitle: "Select the knowledge domains and bases '{name}' can manage (none means 'all')",
      confirmTitle: "Confirm submission?",
      setMessage: "After confirmation, user '{name}' will be set as a Knowledge Officer",
      unsetMessage: "After confirmation, user '{name}' will be removed from Knowledge Officer",
      domainLabel: "Knowledge Domains",
      baseLabel: "Knowledge Bases",
      domainPlaceholder: "Select knowledge domains",
      basePlaceholder: "Select knowledge bases",
      noDomains: "No knowledge domains available",
      noBases: "No knowledge bases available",
      emptyScopeWarning: "No scope selected; the change will be applied as 'all'",
      submit: "Confirm",
      cancel: "Cancel",
      selfProtect: "Cannot perform this action on yourself",
      batchScopeTitle: 'Batch set Knowledge Officer scope',
      batchScopeSubtitle: 'Set scope for {count} selected users (none means \'all\')',
      batchSetMessage: 'After confirmation, {count} selected users will be set as Knowledge Officers',
      batchUnsetMessage: 'After confirmation, {count} selected users will be removed from Knowledge Officer',
      batchConfirmTitle: 'Confirm submission?',
    },
    messages: {
      loadFailed: "Load failed, please retry",
      operationSuccess: "Operation succeeded",
      operationFailed: "Operation failed, please retry",
      selectRequired: "Please select users first",
      selectInconsistent: "Selected users have inconsistent state, cannot perform this action",
      cannotOperateSelf: "Cannot perform this action on yourself",
      addUser: {
        dialogTitle: "Add User",
        dialogSubtitle:
          "Enter a user account or email; an '@' indicates an email invite, otherwise a user ID",
        inputLabel: "User Account / Email",
        inputPlaceholder: "Enter a user account or email",
        submit: "Add",
        cancel: "Cancel",
        emptyInput: "Please enter a user account or email",
        userCreated: "User added",
        createFailed: "Failed to add, please retry",
      },
    },
  },
  answerRecords: {
    title: 'Answer Records',
    subtitle: 'View user Q&A history and feedback across Web and App',
    description: 'Search user conversations by platform, user name, feedback type, and time range. Export is supported.',
    filters: {
      channel: 'Platform',
  ...
  dashboard: {
    subtitle: 'Insights into knowledge bases and user interactions.',
    toolbar: {
      kbSelector: 'All knowledge bases',
      dateRange: 'Date range',
      department: 'Department',
      exportSummary: 'Export summary',
      exportReport: 'Export report',
      viewKbDetail: 'View document details',
      viewUserDetail: 'View user details',
    },
    chart: {
      domainDist: 'Question domain distribution',
      crossDomain: 'Cross-domain answer ratio',
      effectiveAnswer: 'Effective answer rate',
      answerTrend: 'July answer trend',
      qas: 'Q&A count',
      positiveRate: 'Positive rate',
    },
    kbStats: {
      title: 'Knowledge base stats',
      hint: 'Document count and hit rate',
      published: 'Published files',
      uploadSuccess: 'Upload success',
      uploadFailed: 'Upload failed',
      pending: 'Scheduled files',
      offline: 'Offline files',
      archived: 'Archived files',
    },
    basicMetrics: {
      title: 'Answer basics',
      hint: 'Q&A and satisfaction',
      qaTotal: 'Total Q&A',
      askUsers: 'Asking users',
      satisfaction: 'Satisfaction',
      startAnswer: 'Started answers',
      completeAnswer: 'Completed answers',
      avgAnswer: 'Average answer',
    ...
    summary: {
      ...
      highlight: 'On-time answer rate up 4.6%, satisfaction up to 92.3%.',
    },
    overview: {
    ...
    answerBasic: {
      title: 'Answer basics',
      hint: 'Answer source distribution',
    },
    answerDetail: {
      title: 'Answer details',
      hint: 'Answer type and user feedback',
      answerTypeTitle: 'Answer type distribution',
