export default {
  ...
  input: {
    addModel: 'Add Model',
    disclaimer: 'This response is AI-generated and is for reference only. If you have any doubts about the content, you may consult the professional advice of the relevant department.',
  ...
  createChat: {
    title: 'You can ask me about Delegation of Authority (DoA), Travel & Expense (T&E), and Compliance.',
    newSessionTitle: 'Start Chat',
    welcome: {
      greeting: 'Hello {name}, I\'m your enterprise',
      brand: 'smart',
      suffix: 'knowledge assistant',
    },
    messages: {
...
\
  ...
  chat: {
    ...
    addModelUnavailable: 'Model management has been removed. Please configure new models through your provider console.',
    ...
    feedback: {
      ...
      dialog: {
        ...
        reasons: {
          ...
          logic_confusion: 'Confused logic',
