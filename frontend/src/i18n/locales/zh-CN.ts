export default {
  ...
  createChat: {
    title: "您可以对我提问授权委托书(DoA)、差旅报销(T&E)及合规(Compliance)相关的问题",
    newSessionTitle: "开始对话",
    welcome: {
      greeting: "您好{name}，我是您的企业",
      brand: "智能",
      suffix: "知识助手",
    },
    messages: {
  ...
  input: {
    addModel: "添加模型",
    disclaimer: "本回答由AI生成,内容仅供参考。如您对该内容存疑,可以咨询相关部门的专业建议。",
    placeholder: "请输入问题",
  ...
  confidentialityAck: {
    title: "保密确认声明",
    body: "我确认，本人因受雇于罗氏或与罗氏签订的合约所规定的保密义务约束，涉及访问包括 ROCO 及其内容在内的保密信息。本人进入 ROCO 即表示理解：罗氏可能根据当地法律对本人于 ROCO 中的活动进行监督；所有内容与密码均为保密信息；未经授权披露或使用此类保密信息，可能导致包括解除雇佣或服务关系在内的纪律处分，并可能依据当地法律承担法律责任。",
    confirm: "我已阅读并确认",
    close: "关闭",
    ackFailed: "确认失败，请稍后重试",
  },
  commandPalette: {
