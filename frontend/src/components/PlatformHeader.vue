  ...
  <header class="platform-header">
    <div class="platform-header__right">
      ...
      <button type="button" class="lang-switcher" :title="t('header.languageSwitch')"
        ...
        <img :src="flagSrc" :alt="currentLocale === 'zh-CN' ? 'CN' : 'EN'">
...
const currentLocaleLabel = computed(() =>
  currentLocale.value === 'zh-CN' ? t('header.languageZh') : t('header.languageEn')
)

// 国旗图标随当前 locale 切换
const flagSrc = computed(() =>
  currentLocale.value === 'zh-CN'
    ? new URL('../assets/img/CN.svg', import.meta.url).href
    : new URL('../assets/img/EN.svg', import.meta.url).href
)
