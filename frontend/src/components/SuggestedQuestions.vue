...
import { getSuggestedQuestionsNew } from '@/api/chat/index';
import type { SuggestedQuestionNew } from '@/api/chat/index';
...
const questions = ref<SuggestedQuestionNew[]>([]);
...
const fetchQuestions = async () => {
  ...
  loading.value = true;
  try {
    const res = await getSuggestedQuestionsNew();
