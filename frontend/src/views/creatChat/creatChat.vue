    ...
    <div class="dialogue-answers">
      <div class="dialogue-top">
        <div class="dialogue-newSessionTitle">
          <img class="icon-newSessionTitle" src="@/assets/img/newSessionTitle1.svg" alt="newSessionTitle" />
          <span>{{ $t('createChat.welcome.greeting', { name: userName }) }}</span>
          <span class="welcome-brand">{{ $t('createChat.welcome.brand') }}</span>
          <span>{{ $t('createChat.welcome.suffix') }}</span>
