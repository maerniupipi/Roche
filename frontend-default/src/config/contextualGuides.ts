...
export const AGENT_EDITOR_FOCUS_SECTION_EVENT = 'rochekap:agent-editor-focus-section'
...
export const CONTEXTUAL_GUIDE_TOURS: Record<ContextualGuideTourId, ContextualGuideTourConfig> = {
  kbList: {
    storageKey: 'rochekap:contextual-guide-kb-list:v2',
  ...
  kbCreate: {
    storageKey: 'rochekap:contextual-guide-kb-create:v3',
  ...
  knowledgeDomainModels: {
    storageKey: 'rochekap:contextual-guide-knowledgeDomain-models:v1',
    stepI18nPrefix: 'contextualGuide.knowledgeDomainModels.steps',
    openDelayMs: 500,
    steps: [],
  },
  kbDetail: {
    storageKey: 'rochekap:contextual-guide-kb-detail:v1',
  ...
  agentList: {
    storageKey: 'rochekap:contextual-guide-agent-list:v1',
  ...
  agentCreate: {
    storageKey: 'rochekap:contextual-guide-agent-create:v1',
