    ...
    <div class="aside_box" :class="{ 'aside_box--collapsed': uiStore.sidebarCollapsed }">
        ...
        <div class="logo_row" v-if="!uiStore.sidebarCollapsed">
            ...
            <div class="logo_actions">
                <t-tooltip v-if="canManageKnowledge" placement="bottom">
                    <template #content>
                        <span class="cmdk-tip">
        ...
        <div class="menu_top" ref="scrollContainer" @scroll="handleScroll">
            ...
            <div class="menu_box menu_box--cmdk" v-if="uiStore.sidebarCollapsed && canManageKnowledge">
...
const defaultPlatformPath = computed(() =>
    canManageKnowledge.value ? '/platform/knowledge-bases' : '/platform/creatChat'
);
