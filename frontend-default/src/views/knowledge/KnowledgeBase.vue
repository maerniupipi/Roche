...
const VIEW_MODE_KEY = 'rochekap.kb.docs.viewMode';
          ...
          <div class="tag-content">
            <div class="doc-card-area">
              ...
              <div class="doc-batch-bar-anchor" v-show="batchMode || selectedIds.size > 0">
                <DocumentBatchBar :count="selectedIds.size"
                  :reparse-loading="batchReparsing" :visible="batchMode || selectedIds.size > 0"
                  @cancel="handleBatchCancel" @reparse="confirmBatchReparse" />
              </div>
            </div>
          </div>
      </div>
