...
const emit = defineEmits<{
  ...
  (e: 'action', action: 'edit' | 'view-trace' | 'reparse' | 'cancel-parse' | 'move' | 'batch-manage', item: KnowledgeCard): void;
...
// --- Action handlers ---
const handleAction = (action: 'edit' | 'view-trace' | 'reparse' | 'cancel-parse' | 'move' | 'batch-manage', item: KnowledgeCard) => {
    ...
    >
      <div class="card-content">
        <div class="card-content-nav">
          ...
          <t-popup
            v-if="canEdit || item.my_permission === 'manage'"
            v-model="item.isMore"
