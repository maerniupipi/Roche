...
const connectorDefs = computed<ConnectorDef[]>(() => [
  ...
  },
  {
    ...
    permissionDocUrl: 'https://developers.google.com/workspace/drive/api/guides/about-auth',
    permissionPageUrl: 'https://console.cloud.google.com/iam-admin/serviceaccounts',
    requiredPermissions: [
    ...
    fields: [
      {
        ...
        labelKey: 'datasource.field.serviceAccountJson',
        placeholder: '{\n  "type": "service_account",\n  "project_id": "..."\n}',
        secret: true,
        multiline: true,
        hintKey: 'datasource.field.serviceAccountJsonHint',
      },
      {
        key: 'delegated_user',
        labelKey: 'datasource.field.delegatedUser',
        placeholder: 'user@company.com',
        optional: true,
        hintKey: 'datasource.field.delegatedUserHint',
      },
    ],
  },
  {
