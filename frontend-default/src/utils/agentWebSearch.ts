...
/** 解析智能体实际会使用的搜索引擎 ID（与后端 agent > knowledgeDomain default 逻辑一致） */
...
/** 平台默认搜索引擎是否可用（无智能体约束时） */
export function isKnowledgeDomainWebSearchReady(providers: WebSearchProviderEntity[]): boolean {
