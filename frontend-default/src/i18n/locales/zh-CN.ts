export default {
  ...
  agent: {
    ...
    empty: {
      title: "暂无自定义智能体",
      description: "点击右上角按钮创建您的第一个智能体",    favoritesTitle: "暂无收藏",
    ...
    selector: {
      ...
      configureAction: "去配置",      capabilitiesSection: "能力",
  ...
  knowledgeList: {
    ...
    myKnowledgeBases: "我的知识库",myLabel: "我的",
    ...
    uninitializedBanner:
      "部分知识库尚未初始化，需要先在设置中配置模型信息才能添加知识文档",    empty: {
      title: "暂无知识库",
      description: '点击左侧快捷操作"新建知识库"按钮创建第一个知识库',    favoritesTitle: "暂无收藏",
  ...
  vectorStoreBadge: {
    systemDefault: "系统默认",    unknownStore: "未知存储",
    unavailable: "不可用",
  },
  kbSettings: {
    vectorStore: {
